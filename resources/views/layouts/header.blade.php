        ...
        <nav>
            <div class="w-full flex justify-between items-center gap-4">
                ...
                <div class="flex items-center justify-center shrink-0 gap-2">
                    @auth
                        <button class="w-10 h-10 hover:bg-white/10 rounded-lg transition-colors flex items-center justify-center">
                                ...
                                <div class="flex flex-col items-center gap-3.5">
                                    <div class="w-full pb-5 border-b border-slate-200 flex flex-col gap-5">
                                        <div class="flex items-center gap-5">
                                            <div class="flex-1 text-xl font-semibold text-slate-800 leading-8">Notifications</div>
                                            <div class="flex items-center gap-3.5">
                                                ...
                                                <button class="w-6 h-6 flex items-center justify-center hover:bg-slate-100 rounded transition-colors">
                                                    <i data-tabler="x" class="text-slate-950" data-size="18"></i>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="flex flex-col gap-6 max-h-[300px] overflow-y-auto">
                                            <div class="text-sm text-slate-400 text-center py-4">No notifications yet</div>
                                        </div>
                                    </div>
                        ...
                        <div class="dropdown dropdown-end">
                            <div tabindex="0" role="button"
                                ...
                                <span class="text-sm font-medium {{ $iconColor }} hidden md:block max-w-[120px] truncate capitalize">
                    ...
                    @else
                        <div class="dropdown dropdown-end cursor-pointer">
                            ...
                            <ul tabindex="0"
                                ...
                                <li>
                                    <a class="py-3 rounded-lg hover:bg-slate-50" href="javascript:void(0)"
                                        onclick="signup_modal.showModal()">
